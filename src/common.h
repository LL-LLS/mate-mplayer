...
#define ACCEL_PATH_OPEN_LOCATION "<MATE MPlayer>/File/Open Location"
#define ACCEL_PATH_EDIT_SCREENSHOT "<MATE MPlayer>/Edit/Screenshot"
#define ACCEL_PATH_EDIT_PREFERENCES "<MATE MPlayer>/Edit/Preferences"
#define ACCEL_PATH_VIEW_PLAYLIST "<MATE MPlayer>/View/Playlist"
#define ACCEL_PATH_VIEW_INFO "<MATE MPlayer>/View/Info"
#define ACCEL_PATH_VIEW_DETAILS "<MATE MPlayer>/View/Details"
#define ACCEL_PATH_VIEW_METER "<MATE MPlayer>/View/Meter"
#define ACCEL_PATH_VIEW_FULLSCREEN "<MATE MPlayer>/View/Fullscreen"
#define ACCEL_PATH_VIEW_ASPECT "<MATE MPlayer>/View/Aspect"
#define ACCEL_PATH_VIEW_SUBTITLES "<MATE MPlayer>/View/Subtitles"
#define ACCEL_PATH_VIEW_DECREASE_SIZE "<MATE MPlayer>/View/Decrease Size"
#define ACCEL_PATH_VIEW_INCREASE_SIZE "<MATE MPlayer>/View/Increase Size"
#define ACCEL_PATH_VIEW_ANGLE "<MATE MPlayer>/View/Angle"
#define ACCEL_PATH_VIEW_CONTROLS "<MATE MPlayer>/View/Controls"
#define ACCEL_PATH_VIEW_NORMAL "<MATE MPlayer>/View/Normal"
#define ACCEL_PATH_VIEW_DOUBLE "<MATE MPlayer>/View/Double"
